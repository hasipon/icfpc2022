...
pub fn solve(target:&RgbImage) -> State {
    let mut min_state = Element {
        state: State::new(RgbImage::new(target.width(), target.height())),
        score: i64::MAX
    };
...
pub fn find_x_boundary<R:Rng>(_x:i32, right:i32, _y:i32, bottom:i32, target:&RgbImage, rng:&mut R) -> (f64, i32) {
...
pub fn find_y_boundary<R:Rng>(_x:i32, right:i32, _y:i32, bottom:i32, target:&RgbImage, rng:&mut R) -> (f64, i32) {
...
pub fn compare(x1:i32, y1:i32, x2:i32, y2:i32, target:&RgbImage) -> f64 {
