...
vector<int> Ipos = {43,83,123,162,202,241,281,320,360,400};
...
void solve() {
	...
	cut1("0.0.3", 43,83);
	cout << "cut [0.3.0] [y] [399]" << endl;
	col("0.3.0.0", 4278190080);
	cout << "cut [0.3.0.0] [159, 241]" << endl;
	cout << "cut [0.3.0.0.0] [79, 162]" << endl;
	cout << "cut [0.3.0.0.1] [238, 162]" << endl;
	cout << "cut [0.3.0.0.2] [238, 320]" << endl;
	cout << "cut [0.3.0.0.3] [79, 320]" << endl;
	col("0.3.0.0.0.1", 4294967295);
	col("0.3.0.0.0.3", 4294967295);
	col("0.3.0.0.1.1", 4294967295);
	col("0.3.0.0.1.3", 4294967295);
	col("0.3.0.0.2.1", 4294967295);
	col("0.3.0.0.2.3", 4294967295);
	col("0.3.0.0.3.1", 4294967295);
	col("0.3.0.0.3.3", 4294967295);
	cout << "cut [0.3.0.0.0.0] [40, 122]" << endl;
	cout << "cut [0.3.0.0.0.1] [119, 122]" << endl;
	cout << "cut [0.3.0.0.0.2] [119, 202]" << endl;
	cout << "cut [0.3.0.0.0.3] [40, 202]" << endl;
	cout << "cut [0.3.0.0.1.0] [198, 122]" << endl;
	cout << "cut [0.3.0.0.1.1] [277, 122]" << endl;
	cout << "cut [0.3.0.0.1.2] [277, 202]" << endl;
	cout << "cut [0.3.0.0.1.3] [198, 202]" << endl;
	cout << "cut [0.3.0.0.2.0] [198, 280]" << endl;
	cout << "cut [0.3.0.0.2.1] [277, 280]" << endl;
	cout << "cut [0.3.0.0.2.2] [277, 360]" << endl;
	cout << "cut [0.3.0.0.2.3] [198, 360]" << endl;
	cout << "cut [0.3.0.0.3.0] [40, 280]" << endl;
	cout << "cut [0.3.0.0.3.1] [119, 280]" << endl;
	cout << "cut [0.3.0.0.3.2] [119, 360]" << endl;
	cout << "cut [0.3.0.0.3.3] [40, 360]" << endl;
	for (int k = 0; k < 4; ++ k) {
		cout << "swap [0.3.0.0."<<k<<".0.3] [0.3.0.0."<<k<<".3.0]" << endl;
		cout << "swap [0.3.0.0."<<k<<".0.1] [0.3.0.0."<<k<<".3.2]" << endl;
		cout << "swap [0.3.0.0."<<k<<".1.0] [0.3.0.0."<<k<<".2.3]" << endl;
		cout << "swap [0.3.0.0."<<k<<".1.2] [0.3.0.0."<<k<<".2.1]" << endl;
	}
	cut2("0.3.1", 83,400);
}
int main() {
